    ...
    return (
        ...
        >
            ...
            <div className={classes.Icon_text_container}>
                ...
                style={{ color: pathname === '/Football' ? '#30bf1c' : '' }}
                >
                    Football
                </p>
            </div>
